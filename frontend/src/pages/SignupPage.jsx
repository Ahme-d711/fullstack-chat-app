          ...
          <form onSubmit={handleSubmit} className="space-y-6 ">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute inset-y-0 right-0 pr-3 flex items-center focus:outline-none focus:border-none"
                  onClick={() => setShowPassword(!showPassword)}
                >
                  {showPassword ? (
                    <EyeOff className="size-5 z-2 text-base-content/40" />
                  ) : (
                    <Eye className="size-5 z-2 text-base-content/40" />
                  )}
                </button>
              </div>
            </div>
